...
// This is a modified version of threejs orbit controls to include damping for zoom
...
class OrbitControls extends Controls {
  ...
  update(deltaTime = null) {
    ...
    if (this.enableDamping) {
      ...
      this._scale += (1 - this._scale) * this.dampingFactor; // Apply damping to zoom
    } else {
      this._spherical.theta += this._sphericalDelta.theta;
      this._spherical.phi += this._sphericalDelta.phi;
      this._scale = 1; // Reset scale without damping
    }
    ...
    if (this.enableDamping === true) {
      ...
      this._scale += (1 - this._scale) * this.dampingFactor; // Smooth zoom scaling
    } else {
      this._sphericalDelta.set(0, 0, 0);
      this._panOffset.set(0, 0, 0);
      this._scale = 1; // Reset scale
    }
